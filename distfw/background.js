// Load configuration
// importScripts('config.js'); // Moved to manifest.background.scripts for Firefox compatibility
...
// Load ExtPay library
// importScripts('vendor/ExtPay.js'); // Moved to manifest.background.scripts for Firefox compatibility
